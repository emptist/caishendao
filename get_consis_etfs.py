...
def filter_func(symbols,interval='1d',csvl_limit=3,v_limit=None,c_limit=None):  
...
def main():
    ...
    result = filter_func(known,csvl_limit=3)
    print('# generated by running: $: python get_consis_etfs.py > settings_indices.py')
