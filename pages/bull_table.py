...
class BullTableSettings:
    ...
    intervals = ['1h','1d','1wk','1mo','30m','15m']
    filters = ['All','Foot','Fork','Leap','Potential','bcall','buy','sell','bput','cmas_up','breakm','watch','maGood','<BBM','>=BBM','<bb4l','<bb6l','<bbl','<cmal7', '<7', '>=7', 'DonJ', 'JonD']
